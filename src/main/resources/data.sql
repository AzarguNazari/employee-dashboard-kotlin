...
--
--/*---------------------- EMPLOYEE INSERT ---------------------------------*/
--INSERT INTO EMPLOYEE(id, firstName, lastName, salary, title)
--	VALUES (1, 'Adam', 'Smith', 4500 , 'DEVELOPER'),
--	       (2, 'Ahmad', 'Nadimi', 5000 , 'HR'),
--	       (3, 'Jamshid', 'Nazari', 4200 , 'MANAGER');
--
--/*----------------------- TASKS INSERT ---------------------------*/
...
--
--/*----------------------- POPULATE MESSAGES ----------------------*/
--INSERT INTO MESSAGE(id, message, created, employee_id)
--VALUES (1, 'Hey Ahmad, this is Karim', '2020-05-01', 1),
--       (2, 'I want to inform you that this is just a simple reminder', '2020-05-01', 1);
--
...
--       (2, 'true', '2020-08-01');
--
--INSERT INTO USER VALUES (1, "adamSmith", "123", 1),
--                        (2, "ahmadNadimi", "123", 2),
--                        (3, "jamshidNazari", "123", 3);
--
--
--
...
----                                 (3, 2);
--
----INSERT INTO EMPLOYEE_TASK VALUES (1, 1),
----                                 (1, 2),
----                                 (2, 2),
----                                 (3, 3);
